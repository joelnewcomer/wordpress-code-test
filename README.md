...
2. Please do your work in a branch in this repository.
...
## The task
1. All files must be managed in a plugin.
2. Get the quote of the day using the public API at https://theysaidso.com/api/
...
If you have extra time and want to play around, here are some ideas!
